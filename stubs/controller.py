...
class Receiver(Device):
    ...
    def getEmitterDirection(self) -> Tuple[float, float, float]: ...
...
class Field:
    ...
    def setSFVec2f(self, values: Tuple[float, float]) -> None: ...
    def setSFVec3f(self, values: Tuple[float, float, float]) -> None: ...
    def setSFRotation(self, values: Tuple[float, float, float, float]) -> None: ...
    def setSFColor(self, values: Tuple[float, float, float]) -> None: ...
    ...
    def setMFVec2f(self, index: int, values: Tuple[float, float]) -> None: ...
    def setMFVec3f(self, index: int, values: Tuple[float, float, float]) -> None: ...
    def setMFRotation(self, index: int, values: Tuple[float, float, float, float]) -> None: ...
    def setMFColor(self, index: int, values: Tuple[float, float, float]) -> None: ...
